const AboutUs = () =>{
    return (
        <div className="aboutus_container">
            ...
            <p>
                With a commitment to efficiency and innovation, we empower individuals and businesses to take control of their finances and achieve their goals with ease.</p>
            <p>
